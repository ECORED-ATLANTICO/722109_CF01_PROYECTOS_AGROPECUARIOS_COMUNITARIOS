    ...
    .row.justify-content-center.align-items-center
      .col-xl-8
        .img-fnd-flot2.mb-5.img-3
          img.b-img2(src='@/assets/curso/temas/tema2/img47.svg')
          .fl-box2.fl-box3
            p.mb-3.text-color-12263F El método de clasificación se enmarca en aplicar una serie de preguntas por cada componente definido (30), de tal modo que permita una calificación del 1 al 4, donde 1 es el escenario básico y 4 el escenario superior o ideal (Ministerio de Agricultura y Desarrollo Rural Agencia de Desarrollo Rural - ADR, 2019).

...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-3.mb-lg-4.mb-xl-5(data-aos="zoom-in")
      .col-lg-8.mb-4.mb-lg-0
        ...
        p.mb-0 Igualmente propone siete pasos que conducen al diseño de la planeación para el diagnóstico, para esto propone establecer un objetivo del diagnóstico, seleccionar y preparar el equipo facilitador, identificar participantes potenciales, identificar las expectativas de los y las participantes en el DRP, discutir las necesidades de información, seleccionar herramientas de investigación y por último diseñar el proceso de diagnóstico (Exposito, 1999).

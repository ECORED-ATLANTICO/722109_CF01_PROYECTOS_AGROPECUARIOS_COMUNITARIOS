...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.b-r-b
    ...
    .row.justify-content-center.align-items-center(data-aos="fade-left")
      .col-lg-10
        ...
        .bloque-texto-f.color-primario.pt-4.px-5.mb-3.fnd-1
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade-left")
      .col-lg-10
        ...
        .bloque-texto-f.bg-color-1.pt-4.px-5.fnd-1-.fnd-1
          .bloque-texto-f__comillas
            i.fas.fa-quote-left
            i.fas.fa-quote-right
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.b-r-t
    ...
    .bloque-texto-g.bg-color-2.p-3.p-sm-4.p-md-5.mb-5.fnd-4(data-aos="fade-left")
        .bloque-texto-g__img(

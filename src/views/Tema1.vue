...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.b-r-b
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade-left")
      .col-lg-10
        .bloque-texto-f.pt-4.px-5.fnd-1
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade-left")
      .col-lg-10
        ...
        .bloque-texto-f.pt-4.px-5.fnd-4
          .bloque-texto-f__comillas
            i.fas.fa-quote-left
            i.fas.fa-quote-right
      ...
      .row.justify-content-center.align-items-center.mb-3(data-aos="zoom-in")
        .col-md-12.col-lg-10
          LineaTiempoD.color-secundario.mb-5
            ...
            .row.justify-content-center.align-items-center(numero="1936" titulo="El tercer período")
              .col-lg-8.mb-4.mb-md-0.mt-3.order-2.order-lg-1
              ...
              .col-lg-4.mt-3.order-1.order-lg-2.col-md-8
                figure.mb-4.mb-lg-0
    ...
    .row.justify-content-center.align-items-center.mb-0(data-aos="zoom-in")
      .col-lg-12.col-md-12.order-1.order-lg-2 
        .bloque-texto-g.bg-color-2.p-3.p-sm-4.p-md-5.mb-0(data-aos="fade-left")
          .bloque-texto-g__img(

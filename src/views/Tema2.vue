...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .col-md-6.col-lg-4.col-xl-3
          .tarjeta-container.mb-4.custom-mh
            .position-relative.bg-color-3.p-3.rounded-4.tarjeta-label.custom-mh.ms-4.d-flex.align-items-center
              img.tarjeta-label__icon.position-absolute.img-85(src='@/assets/curso/temas/tema2/img03.svg' alt='AvatarTop')
              p.ms-5.mb-0 <b>Norma constitucional:</b> ocupa dentro del ordenamiento jurídico el rango más elevado, es la norma suprema dentro del ordenamiento jurídico.
         
        .col-md-6.col-lg-4.col-xl-4
          .tarjeta-container.mb-4.custom-mh
            .position-relative.bg-color-3.p-3.rounded-4.tarjeta-label.custom-mh.ms-4.d-flex.align-items-center
              img.tarjeta-label__icon.position-absolute.img-85(src='@/assets/curso/temas/tema2/img03.svg' alt='AvatarTop')
              p.ms-5.mb-0 <b>Ley: </b>norma general y abstracta que en su creación debe tener en cuenta la norma constitucional y que es creada según los preceptos establecidos en las normas constitucionales.
         
        .col-md-12.col-lg-4.col-xl-5
          .tarjeta-container.mb-4.custom-mh
            .position-relative.bg-color-3.p-3.rounded-4.tarjeta-label.custom-mh.ms-4.d-flex.align-items-center
              img.tarjeta-label__icon.position-absolute.img-85(src='@/assets/curso/temas/tema2/img03.svg' alt='AvatarTop')
    ...
    .row.justify-content-center.align-items-center(data-aos="zoom-in")
      .col-lg-12
        ...
        .row.justify-content-center.align-items-center
          .col-lg-12
            figure.mb-5
              img.mb-3.d-none.d-lg-block(src='@/assets/curso/temas/tema2/img07.svg', alt='Normatividad del sector agropecuario en Colombia')
              img.mb-3.d-block.d-lg-none(src='@/assets/curso/temas/tema2/img08.svg', alt='Normatividad del sector agropecuario en Colombia')
        ...
        .row.justify-content-center.align-items-center
          .col-lg-12
            figure.mb-5
              ...
              figcaption <b>Nota.</b> Secretarios de Cadenas Pecuarias Ministerio de Agricultura.
      ...
      .col-lg-9.order-md-1.order-lg-2.mb-4.mb-lg-0
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Participación de los actores en la formulación del PDEA
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Formulación cuatrienal del PDEA
              img.image(src='@/assets/curso/temas/tema2/icon_subt.svg', alt='Imagen decorativa')
            ...
            .row.justify-content-center.align-items-center
              .col-lg-12.fnd-10
                ...
                LineaTiempoC.color-acento-botones
                  .row.justify-content-center(titulo="Desarrollo")
                  ...
                  .row.justify-content-center(titulo="Acceso")
                    .col-lg-6.mb-4.mb-md-0.px-5.order-2.order-lg-1
                  ...
                  .row.justify-content-center(titulo="Sostenibilidad")
                    .col-lg-6.mb-4.mb-md-0.px-5.order-2.order-lg-1
                  ...
                  .row.justify-content-center(titulo="Habilidades")
                    .col-lg-6.mb-4.mb-md-0.px-5.order-2.order-lg-1
    ...
    .align-items-center.justify-content-star.mb-2
      .div(data-aos="fade-left")
        h3.subtitle.position-relative Requisitos de habilitación de Entidades Prestadoras del Servicio de Extensión Agropecuaria (EPSEA)
          img.image(src='@/assets/curso/temas/tema2/icon_subt.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-3(data-aos="zoom-in")
      ...
      .col-lg-9.col-md-12.mb-4.mb-lg-2
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Capacidades para ejecutar los PDEA
              img.image(src='@/assets/curso/temas/tema2/icon_subt.svg', alt='Imagen decorativa')
      ...
      .align-items-center.justify-content-star.mb-2
        .div(data-aos="fade-left")
          h3.subtitle.position-relative Constitución y situación legal conforme 
            img.image(src='@/assets/curso/temas/tema2/icon_subt.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-3(data-aos="zoom-in")
      ...
      .col-lg-9
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Recurso humano, formación profesional experiencia y desarrollo de competencias
              img.image(src='@/assets/curso/temas/tema2/icon_subt.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Capacidades para ejecutar los Planes Departamentales de Extensión Agropecuaria (PDEA)
              img.image(src='@/assets/curso/temas/tema2/icon_subt.svg', alt='Imagen decorativa')
        ...
        .col-lg-12.mb-3
          .row 
            .col-md-12.col-lg-auto
              .tarjeta-numerada.color-secundario.p-4.py-4(style="margin-left: 15px;")
                .tarjeta-numerada__numero
                  .h2 1
                p.mb-0(style="margin-left: 15px;") Los recursos propios de los entes territoriales.

        .col-lg-12.mb-3
          .row 
            .col-md-12.col-lg-auto
              .tarjeta-numerada.color-acento-botones.p-4.py-4(style="margin-left: 15px;")
                .tarjeta-numerada__numero
                  .h2 2
                p.mb-0(style="margin-left: 15px;") Los recursos del presupuesto general de la nación.
          ...
          .row 
            .col-md-12.col-lg-auto
              .tarjeta-numerada.color-secundario.p-4.py-4(style="margin-left: 15px;")
                .tarjeta-numerada__numero
                  .h2 3
                p.mb-0(style="margin-left: 15px;") Los recursos de libre inversión del componente de propósito general del sistema general de participaciones.
          ...
          .row 
            .col-md-12.col-lg-auto
              .tarjeta-numerada.color-acento-botones.p-4.py-4(style="margin-left: 15px;")
                .tarjeta-numerada__numero
                  .h2 4
                p.mb-0(style="margin-left: 15px;") Los recursos del sistema general de regalías, de acuerdo con las disposiciones de la comisión rectora y de los órganos colegiados de administración y decisión.
          ...
          .row 
            .col-md-12.col-lg-auto
              .tarjeta-numerada.color-secundario.p-4.py-4(style="margin-left: 15px;")
                .tarjeta-numerada__numero
                  .h2 5
                p.mb-0(style="margin-left: 15px;") Los instrumentos financieros creados en el marco del sistema nacional de crédito agropecuario.
          ...
          .row 
            .col-md-12.col-lg-auto
              .tarjeta-numerada.color-acento-botones.p-4.py-4(style="margin-left: 15px;")
                .tarjeta-numerada__numero
                  .h2 6
                p.mb-0(style="margin-left: 15px;") Los recursos de cooperación internacional.
          ...
          .row 
            .col-md-12.col-lg-auto
              .tarjeta-numerada.color-secundario.p-4.py-4(style="margin-left: 15px;")
                .tarjeta-numerada__numero
                  .h2 7
                p.mb-0(style="margin-left: 15px;") Las donaciones de personas naturales o jurídicas, nacionales o extranjeras y organismos internacionales, de conformidad con la normatividad vigente.
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-8.col-xl-9
        AcordionA(tipo="a" clase-tarjeta="tarjeta--azul")
          ...
          .row(titulo="3. Economía campesina, familiar y comunitaria")
          ...
          .row(titulo="4. Economía solidaria")
          ...
          .row(titulo="5. Mercados campesinos y comunitarios")
